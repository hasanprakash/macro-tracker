-- =============================================================================
-- RPC Function: delete_food_entry
-- =============================================================================
-- Deletes a food entry and atomically updates the daily summary for that date.
-- Prevents race conditions, enforces user authorization via auth.uid(),
-- and ensures 100% transactional consistency.
-- =============================================================================
...
begin
  ...
  -- 3. Extract entry date (in UTC to match ISO string date)
  ...
  -- 5. Atomically update the daily summary with row-level lock (FOR UPDATE)
